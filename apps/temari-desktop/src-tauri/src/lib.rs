...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            managed_api::managed_preview_library_reorganization,
            managed_api::managed_apply_library_reorganization,
            managed_api::managed_resume_library_reorganization,
            managed_api::managed_undo_library_reorganization,
